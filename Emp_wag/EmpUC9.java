...
public class EmpUC9{
	...
	Mmart.computeEmployeeWage();

	System.out.println("The Total Wage earned by Employee in DMART is : "+ Dmart.totalWage);
	System.out.println("The Total Wage earned by Employee in MMART is : "+ Mmart.totalWage);
